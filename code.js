...
function generateCV(){
   ...
   document.getElementById("emailT").innerHTML=document.getElementById("emailField").value;
    ...
    // contact
    document.getElementById("countryContactT").innerHTML=document.getElementById("countryCode").value;
    ...
    //  Social media Links
    document.getElementById("githubT").innerHTML = document.getElementById("fbField").value;
    ...
    //  Job Title
    document.getElementById("jobTitleT").innerHTML=document.getElementById("jobTitle").value;;
...
async function captureDivAndDownloadPdf() {
    ...
    try {
        ...
        while (remainingCanvasHeight > 0) {
            ...
            const contentHeightOnPage = Math.min(remainingCanvasHeight, pdfHeight / contentScaleFactor);
            ...
            pdf.addImage(imgData, 'PNG', 0, 0, pdfWidth, contentHeightOnPage * contentScaleFactor);
